...
options(
  ...
  # I assume set default author of posts (17-Apr-2021)
  blogdown.author = "Dario J C",
  # I assume this sets default file type (17-Apr-2021)
  blogdown.ext = ".Rmd",
  # I assume this chooses where the file will live (17-Apr-2021)
